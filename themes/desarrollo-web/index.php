<?php get_header() ?>
	<section id="section-intro" class="[ relative ][ bg-image ][ margin-top-50 ]" style="background-image: url(<?php echo THEMEPATH ?>images/intro.png);">
		...
		<div class="[ container ][ relative ][ padding-top-bottom-section ][ frase ][ text-center ]">
			...
			lorem ipsum olor sit amet lorem ipsum</p>
	...
	<section class="[ relative ][ bg-image ]" style="background-image: url(<?php echo THEMEPATH ?>images/frase1.png);">
		<div class="[ bg-light-opacity ][ absolute top-0 bottom-0 left-0 right-0 ]"></div>
		<div class="[ container ][ relative ][ padding-top-bottom-section ][ frase ][ text-center ]">
			<p>Lorem ipsum dolor sit amet lorem ipsum dolor sit amet
			lorem ipsum olor sit amet lorem ipsum</p>
			...
			<div class="carousel-item active">
				<div class="[ card ]">
					...
					<div class="[ card-content ][ padding-top-bottom-xlarge ]">
						...
						<p>Lorem ipsum dolor sit amet lorem ipsum sit amet Lorem ipsum dolor sit amet lorem ipsum sit amet</p>
	...
	<section class="[ relative ][ bg-image ]" style="background-image: url(<?php echo THEMEPATH ?>images/frase2.png);">
		<div class="[ bg-light-opacity ][ absolute top-0 bottom-0 left-0 right-0 ]"></div>
		<div class="[ container ][ relative ][ padding-top-bottom-section ][ frase ][ text-center ]">
			<p>Lorem ipsum dolor sit amet lorem ipsum dolor sit amet
			lorem ipsum olor sit amet lorem ipsum</p>
